define(["require", "exports", './../../../src/easelts/geom/Matrix4', './webgltest2/Shader'], function (require, exports, m4, Shader) {
    //import Vector3 = require('../../../src/easelts/geom/Vector3');
    var WebGLTest2 = (function () {
        function WebGLTest2(canvas) {
            this.canvas = canvas;
        ...
        WebGLTest2.prototype.getGL = function (canvas) {
            var gl;
            try {
        ...
        WebGLTest2.prototype.initBuffers = function (gl) {
        ...
        WebGLTest2.prototype.setMatrixUniforms = function (gl, shaderProgram, perspectiveMatrix, mvMatrix) {
        ...
        WebGLTest2.prototype.drawScene = function () {
            var gl = this.gl;
