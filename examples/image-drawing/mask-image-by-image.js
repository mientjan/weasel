define(["require", "exports", '../../src/easelts/display/Stage', '../../src/easelts/display/Bitmap', '../../src/easelts/display/Container'], function (require, exports, Stage_1, Bitmap_1, Container_1) {
    var holder = document.getElementById('holder');
    var stage = new Stage_1.default(holder, true);
    var container = new Container_1.default().setRenderIsolation(true);
